...
- “我想减脂，但晚上总控制不住吃东西；别给我极端协议。”
- “我想少喝酒，但不想被逼着完全戒；先帮我改下班这一杯。”
- “我做了三天又乱了，是不是我自律太差？”
- “红光、冷水澡、桑拿和补剂这么多，哪个根本不值得做？”
- “我试过一个方法但没效果，帮我复盘，只改一个变量。”
- “我想深入看看这个建议到底有什么证据。”

即使你没有提到 Huberman，普通睡眠、精力、压力、专注、习惯、运动、饮食、体重/食欲和少喝酒问题也可以自动触发。你也可以显式调用：
...
| 想减脂、控制食欲或体重突然变化 | 先排除药物、疾病和进食失控等风险；一般场景只改一个环境，绝不先塞断食、热量或补剂协议 |
| 想少喝酒、靠酒入睡或担心醉酒安全 | 尊重用户自己的减量目标，只改一个场景；戒断、药物混用、孕期和酒精过量先走明确安全分流 |
...
当前公开快照包括：425 期官方节目索引、65 张结构化研究证据卡、42 条研究间关系、16 个行动剧本、48 个带停止条件和调整规则的动作，以及 1,736 个节目来源记录和 5 个外部酒精安全来源。公开仓库只保留可复现的结构化索引、摘要、定位器和生成脚本，不分发大段第三方转录文本。
...
python scripts/query_action_playbooks.py "想少喝酒，但停一天会手抖" --json
