...
即使你没有提到 Huberman，普通睡眠、精力、压力、专注、习惯、运动、饮食和体重/食欲问题也可以自动触发。你也可以显式调用：
...
当前公开快照包括：425 期官方节目索引、60 张结构化研究证据卡、38 条研究间关系、15 个行动剧本、45 个带停止条件和调整规则的动作，以及 1,736 个来源记录。公开仓库只保留可复现的结构化索引、摘要、定位器和生成脚本，不分发大段第三方转录文本。
