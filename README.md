...
- “我睡前一刷短视频就到两三点，但不想戒整部手机。”
- “我做了三天又乱了，是不是我自律太差？”
- “红光、冷水澡、桑拿和补剂这么多，哪个根本不值得做？”
- “我试过一个方法但没效果，帮我复盘，只改一个变量。”
- “我想深入看看这个建议到底有什么证据。”

即使你没有提到 Huberman，普通睡眠、精力、压力、专注、习惯、运动、饮食、体重/食欲、少喝酒和刷手机停不下来等问题也可以自动触发。你也可以显式调用：
...
| 刷手机停不下来或明明困了仍不睡 | 不要求戒整部手机；只改一个应用和时刻，保留值班、照护与紧急联络，并看睡眠、工作或相处是否真的改善 |
...
当前公开快照包括：425 期官方节目索引、72 张结构化研究证据卡、47 条研究间关系、17 个行动剧本、51 个带停止条件和调整规则的动作，以及 1,736 个节目来源记录。公开仓库只保留可复现的结构化索引、摘要、定位器和生成脚本，不分发大段第三方转录文本。
...
python scripts/query_action_playbooks.py "睡前刷短视频停不下来" --json
