...
- 749 个去重学术/医学来源，674 个已核验、75 个待核验；其中 113 条已完成原始研究级核查，待核验来源已按修复原因分流
- 5 张结构化高关联研究证据卡，显式记录设计、样本、阴性/反向结果、局限与安全解释，并确定性回写 7 条来源记录
- 研究证据图谱包含 5 个研究卡、18 个结果/阴性发现、25 个局限及 20 个证据主题节点，共 8,426 条可追溯关系
- 40 个脱敏的主张定位记录
...
当前版本：`0.3.1`，研究预览版。公开发布前仍建议由熟悉版权、商标和平台条款的专业人士复核，尤其是仓库命名、人物名称的描述性使用，以及任何商业化场景。
