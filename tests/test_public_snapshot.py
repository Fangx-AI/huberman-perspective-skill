...
class PublicSnapshotTests(unittest.TestCase):
    ...
    def test_claim_index_is_locator_only(self) -> None:
        ...
        self.assertEqual(sum(bool(record.get("timestamps")) for record in records), 22)
    ...
    def test_public_graph_has_no_show_notes_payload(self) -> None:
        ...
        self.assertEqual(graph["stats"]["claim_nodes"], 43)
        self.assertEqual(graph["stats"]["verified_academic_resource_nodes"], 710)
