...
- 非紧急压力与呼吸决策：先区分短时生理唤醒、心肺/神经急症、现实危险，以及反复或持续的焦虑/惊恐；后三类不得先套呼吸协议。最终回答即使用户要求简短，也不得省略胸痛/严重或新发气促/晕厥或神经异常/自伤他伤风险/现实危险的急症分流，反复惊恐/持续焦虑/创伤解离/功能受损的专业分流，以及驾驶、游泳、浴缸、冷水、高处、机械操作、不用力、不计时、快速过度换气和屏息边界。回答必须主动保留三个会改变决定的边界：108人、远程、探索性且回顾注册的四组研究中，循环叹息优势主要落在正性情绪和呼吸率，没有证明其状态焦虑下降优于正念，特质焦虑、HRV、静息心率和睡眠均无改善；较广的呼吸训练荟萃分析对自评压力只有小到中等平均效应，未发现明确剂量—反应，随访与安全报告有限；纳入12项急性状态焦虑RCT的后续综述中，单独呼吸干预总体不显著，主动改变呼吸和注意呼吸均高度异质。只有一般成人处于轻到中度、非紧急压力且环境安全时，才可把温和、不用力、可立即停止的呼气偏重练习作为一次可撤销选项；不得在驾驶、游泳、浴缸、冷水、高处或机械操作时练，不做快速过度换气、屏息或追求麻木眩晕。专注呼吸若加重焦虑、气短、头晕、刺麻、胸痛、心悸不适、失控感或接近晕厥，立即停止并按严重程度求助；反复惊恐、持续焦虑、创伤/解离或功能受损转专业支持，不用更多呼吸法覆盖根因。
...
- 桑拿/热暴露决策：先把目标分为个人享受/放松、运动恢复、疾病治疗，以及激素/减脂/长寿/泛健康。后四类目标不得因为节目机制、出汗或队列频率而默认购买或硬凑次数；疾病目标必须转临床团队。最终回答必须主动报告以下六个会改变决定的边界，即使用户要求简短也不能省略任何一个：芬兰死亡率结果是观察关联而非随机因果；17人极端重复暴露中的生长激素峰值是短暂反应，睾酮、甲状腺激素、FSH和LH无显著变化且7名女性中5名出现暂时性闭经；30名年轻男性的桑拿—冷水组合中睾酮、DHEA-S和催乳素无显著变化；更新的20项RCT综述对多数心血管、血糖、血脂和炎症结局总体阴性；41人稳定冠心病RCT只有热适应、没有血压或血管功能改善；运动恢复结果混合，不能把桑拿固定成每次训练后的必需步骤。热适应、流汗和汗后体重下降都不等于临床获益、减脂或长寿。不得把观察队列的每周组别或任何研究方案改写成通用温度、时长、频率或冷热交替协议。只有一般健康成人因享受而自愿使用并通过医学/环境安全门时，才可作为非必需、可立即停止的偏好行为；安全门必须逐项筛查晕厥/低血压、心血管或肾脏疾病、孕期、发热/急性感染、相关用药，以及场所能否安全离开、冷却和获得帮助。禁止酒后、独自高热挑战和强制冷水组合，出现头晕/晕厥、胸痛、异常气促、心悸伴不适、混乱、严重头痛、无法冷却或烧伤立即停止并按严重程度求助。
...
- [主张级索引](references/catalog/claim-index.jsonl)：从本地批次分析中保守导出的 41 条公开来源定位，含中性主题、官方 Episode/YouTube ID/URL、时间戳、证据层、说话者范围和边界；不含逐字主张、完整字幕或 Show Notes。详细字幕分析只保留在维护者的合法本地研究缓存，不随公开仓库分发。
- [行为验证用例](references/evals/behavioral-cases.md)：用于独立复测的已知观点、边缘推断和医学边界测试。
- [独立黑盒评测记录](references/evals/blackbox-2026-08-31.md)：2026-08-31 由独立只读 Codex 上下文完成的 Case 1–15 行为复测结果，包括学习/路由退化，以及健康协议、冷暴露、红光、桑拿和呼吸决策边界遗漏的发现与修复。
