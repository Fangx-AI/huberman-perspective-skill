...
| Put user outcomes ahead of knowledge accumulation | Eight outcome-first playbooks and Cases 5–12 | Implemented for eight high-frequency scenarios; more scenarios remain |
...
The public academic queue contains 1,736 deduplicated Show Notes URLs. Only 677 have bibliographic or stronger verification, and only 26 high-priority papers currently have full structured study cards. `verified-bibliographic` confirms identity only; it cannot support efficacy. The remaining queue and future episodes keep the long-term Goal active.
